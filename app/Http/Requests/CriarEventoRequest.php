...
class CriarEventoRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'local.max' => 'O local deve possuir no máximo 255 caracteres.',

            'data_evento.required' => 'A data do evento é obrigatória.',
            'data_evento.date' => 'Informe uma data válida.',
            ...
            'horario_inicio.date_format' => 'Informe um horário de início válido.',

            'horario_fim.required' => 'O horário de término é obrigatório.',
            'horario_fim.date_format' => 'Informe um horário de término válido.',
